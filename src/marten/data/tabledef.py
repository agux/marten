...
class ta_ma(Base):
    ...
    vwap_vwap5 = Column(Numeric, nullable=True)
    vwap_vwap20 = Column(Numeric, nullable=True)
    vwap_vwap100 = Column(Numeric, nullable=True)
...
class ta_price_characteristics(Base):
    ...
    roc_with_band_roc5 = Column(Numeric, nullable=True)
    roc_with_band_roc20 = Column(Numeric, nullable=True)
    roc_with_band_roc50 = Column(Numeric, nullable=True)
    roc_with_band_roc_ema5 = Column(Numeric, nullable=True)
    roc_with_band_roc_ema20 = Column(Numeric, nullable=True)
    roc_with_band_roc_ema50 = Column(Numeric, nullable=True)
    roc_with_band_upper_band5 = Column(Numeric, nullable=True)
    roc_with_band_upper_band20 = Column(Numeric, nullable=True)
    roc_with_band_upper_band50 = Column(Numeric, nullable=True)
    roc_with_band_lower_band5 = Column(Numeric, nullable=True)
    roc_with_band_lower_band20 = Column(Numeric, nullable=True)
    roc_with_band_lower_band50 = Column(Numeric, nullable=True)
