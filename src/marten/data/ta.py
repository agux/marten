...
def price_characteristics(quotes_list, symbol, table):
    ...
    columns = [
        ...
        "roc_with_band_roc20",
        "roc_with_band_roc50",
        "roc_with_band_roc_ema5",
        "roc_with_band_roc_ema20",
        "roc_with_band_roc_ema50",
        "roc_with_band_upper_band5",
        "roc_with_band_upper_band20",
        "roc_with_band_upper_band50",
        "roc_with_band_lower_band5",
        "roc_with_band_lower_band20",
        "roc_with_band_lower_band50",
        "pmo_pmo",
        "pmo_signal",
        "tsi_tsi",
        "tsi_signal",
